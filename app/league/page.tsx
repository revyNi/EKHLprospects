      ...
      <div style={shell}>
        <div style={card}>
          <div style={cardHeaderRow}>
            <div style={pageTitle}>Leagues</div>
          ...
          <div style={leaguePanel}>
            <div style={tabsRow}>
              {leagueRegions.map((region) => (
                <div key={region.key} style={tabStyle}>
                  {region.title}
                </div>
              ))}
            </div>
                ...
                return (
                  ...
                  >
                    {regionLeagues.map((league) => (
                      <Link key={league.id} href={`/league/${league.id}`} style={leagueRow}>
                        {getFlagUrl(league.country_code) ? (
                          ...
                          <span style={flagBox}>
                            {getCountryCode(league.country_code)}
                          </span>
                        )}
                    ...
                    {isLoading ? <LoadingExperience compact label="Loading leagues..." /> : null}
                  </div>
                )
              })}
            </div>
          ...
          <div style={leaguePanel}>
            ...
            <div style={internationalTabsRow}>
              {internationalLevels.map((level) => (
                <div key={level.key} style={tabStyle}>
                  {level.title}
                </div>
              ))}
            </div>
